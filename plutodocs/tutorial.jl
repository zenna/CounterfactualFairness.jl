...
begin
	...
	Pkg.add(url = "https://github.com/zenna/Omega.jl#102cc01d1f7dbb4a4caad822746ced6fa5c7164b:OmegaCore")
	Pkg.add(url = "https://github.com/zenna/Omega.jl#102cc01d1f7dbb4a4caad822746ced6fa5c7164b:OmegaMH")
	Pkg.add(url = "https://github.com/zenna/Omega.jl#102cc01d1f7dbb4a4caad822746ced6fa5c7164b:InferenceBase")
	Pkg.add(url = "https://github.com/zenna/Omega.jl#102cc01d1f7dbb4a4caad822746ced6fa5c7164b:ReplicaExchange")
	Pkg.add(url = "https://github.com/zenna/Omega.jl#102cc01d1f7dbb4a4caad822746ced6fa5c7164b:SoftPredicates")
	Pkg.add("Colors")
	using Omega, OmegaCore, LightGraphs, Distributions
end

# ╔═╡ 4f7d94b6-7678-46fc-9483-830075d4e5c8
begin
	Pkg.add(url = "https://github.com/zenna/CounterfactualFairness.jl#arw")
...
# ╔═╡ 166087dd-e3b7-4b99-99ee-d1d3eb4ff1ce
Pkg.precompile()
...
md"In the above causal model, we could set the value of temperature to 24 and modify the entire model accordingly (by removing all incoming edges to temperature since it now has a fixed value) as given below -"
